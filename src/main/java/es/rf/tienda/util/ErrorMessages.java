...
public class ErrorMessages {
	...
	public final static String ERM_005 = "Please provide Direction";
	
	public final static String ERM_006 = "Please provide Confirm Password";
	
	public final static String ERM_007 = "Please provide ";
	
	public final static String ERM_008 = "Please provide ";
